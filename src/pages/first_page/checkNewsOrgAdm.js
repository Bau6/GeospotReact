                                        ...
                                        <div key={newsItem.id} className={FirstPageCss.newsItem}>
                                            ...
                                            <div className={FirstPageCss.newsDetails}>
                                                <div className={FirstPageCss.newsMain}>
                                                    <span
                                                        className={FirstPageCss.newsText}>{newsItem.namePub} </span><br/>
                                                    <span
                                                ...
                                                <div>
                                                    <button onClick={() => this.handleNews(newsItem.id, 7)}
                                                            className={buttonNews.buttonDelete}>Удалить запись
                                                    </button>
                                                </div>
                                                <div>
                                                    {this.props.role === "admin" && (
                                                        <button onClick={() => this.handleNews(newsItem.id, 1)}
                                                                className={buttonNews.buttonAdd}>Опубликовать
                                                            запись</button>
                                                    )}
                                                </div>
                                            </div>
